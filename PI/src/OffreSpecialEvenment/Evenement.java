...
public class Evenement {
    ...
    public String toString() {
        return "Evenement{" + "catégorie=" + TypeEvenement + ", date_depart=" + date_depart + ", description=" + description + ", destination=" + destination + ", guide_id=" + guide_id + ", IdEvenement=" + IdEvenement + ", image=" + image + ", prix=" + prix + ", titre=" + titre + ", SponsorEvenement=" + SponsorEvenement + '}';
    }
