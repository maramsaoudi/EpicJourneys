...
import static edu.esprit.api.SMS.ACCOUNT_SID;
import static edu.esprit.api.SMS.AUTH_TOKEN;
...
public class AjouterevenementController implements Initializable {
  ...
  private Stage primaryStage;
   public static final String ACCOUNT_SID = "AC836eab96a74c077c9c1f66979efa2999"; // Replace with your Twilio Account SID
    public static final String AUTH_TOKEN = "86f53cbc5000365e6cf0c5b3e29f9ef8";     // Replace with your Twilio Auth Token
...
//       if (messageResult.getStatus() != null && !messageResult.getStatus().equals("delivered")) {
