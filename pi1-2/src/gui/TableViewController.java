...
public class TableViewController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        tbtnmodifier.setOnMouseClicked((t) -> {
            ...
            if (selectedUser != null) {
                ...
                alertz.setTitle("Error");
                alertz.setHeaderText(null);
                alertz.setContentText("Selectionnez un utilsiateur !");
                alertz.showAndWait();
            }
        ...
        if (selectedUser != null) {
            ...
            if (result.get() == ButtonType.OK) // alert is exited, no button has been pressed.
            {
                if (serviceuser.supprimerUtilisateur(selectedUser.getId())) {
                    ...
                    alerts.setContentText("l'utilsiateur " + selectedUser.getNom() + " a été supprimée");
                    alerts.showAndWait();
                    clearInputFields();
                    affichage();
                } else {
                    ...
                    alertz.setTitle("Error");
                    alertz.setHeaderText(null);
                    alertz.setContentText("l'utilsiateur " + selectedUser.getNom() + "n'a pas été supprimée");
                    alertz.showAndWait();
                }
            }
    ...
    public boolean isValidPhone(String input) {
        if (input == null || input.length() != 8) {
            ...
            return false; // tchouf ken el param  null or toulou not 8
        }
        char firstChar = input.charAt(0); // tekhou awel noumrou
        // tchoufou ken '2', '5', or '9'
