...
public class MainClass {
  ...
  public static void main(String[] args)  {
     ...
     /*   
      User utilisateur = new User();
        ...
        utilisateur.setMotDePasse("Femme");
        utilisateur.setNumeroTelephone("123");
        utilisateur.setDateNaissance("07/06/2000");
  ...
  /*    utilisateur.setId(1); // Remplacez 1 par l'ID de l'utilisateur que vous souhaitez modifier
    ...
    utilisateur.setRole(UserRole.ADMIN); // Spécifiez le nouveau rôle de l'utilisateur
    ...
    System.out.println("Utilisateur modifié avec succès !");
      ...
      /*************************/
   /*  User utilisateurRecherche = UserCRUD.rechercherUtilisateurParId(2);
  ...
  /*  int idUtilisateurASupprimer = 7; // Remplacez par l'ID de l'utilisateur que vous souhaitez supprimer
